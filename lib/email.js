    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api rian - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=62815293692739">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>RIAN API</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"RIAN API" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - RIAN API`,
        html: inboxGmail,
      };
